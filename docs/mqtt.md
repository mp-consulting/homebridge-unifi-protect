...
Doorbell messages are a fun feature available in UniFi Protect doorbells. You can read the [doorbell documentation](https://github.com/mp-consulting/homebridge-unifi-protect/blob/main/docs/doorbell.md) for more information about what the feature is and how it works.
