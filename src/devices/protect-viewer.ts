...
export class ProtectViewer extends ProtectDevice {
  ...
  public updateDevice(configureHandlers = false): string[] {
    ...
    // Finally, reflect the state of the liveview that's currently enabled. We loop through the list of services on our viewer accessory and
    // sync the liveview switches.
