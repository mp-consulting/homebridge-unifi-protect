...
export class ProtectDoorbell extends ProtectCamera {
  ...
  protected configureDevice(): boolean {
    ...
    this.defaultMessageDuration = this.nvr.ufp.doorbellSettings?.defaultMessageResetTimeoutMs ?? PROTECT_DOORBELL_MESSAGE_DURATION;
  ...
  protected eventHandler(packet: ProtectEventPacket): void {
    ...
    // sensor to trigger the package camera's HKSV
    // event recording.
